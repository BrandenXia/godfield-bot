...
normalized API state. `api-combo-utility-heuristic-v3` uses strict
...
late fallback after deterministic attacks and HP/MP utility.
...
`live-resource-shadow-readiness-v3` accepts only runs that carry the exact v3
