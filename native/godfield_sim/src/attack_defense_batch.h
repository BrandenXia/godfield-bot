...
inline constexpr std::uint32_t
    kDynamicMpWeaponResourceAttackDefenseKernelSchemaVersion = 1;
inline constexpr std::uint32_t
    kDynamicMpWeaponResourceAttackDefenseObservationSchemaVersion = 6;
inline constexpr const char *kDynamicMpWeaponResourceAttackDefenseRulesetId =
...
inline constexpr std::uint32_t
    kAttackTwiceWeaponResourceAttackDefenseKernelSchemaVersion = 1;
inline constexpr std::uint32_t
    kAttackTwiceWeaponResourceAttackDefenseObservationSchemaVersion = 6;
inline constexpr const char *kAttackTwiceWeaponResourceAttackDefenseRulesetId =
    "plain-elemental-combo-stochastic-chance-absorption-weapon-dynamic-mp-"
    "same-damage-weapon-attack-twice-weapon-additive-reflection-dual-role-"
    "resource-miracle-attack-defense-redraw-duel-v1";
inline constexpr std::uint32_t
    kRandomTargetWeaponResourceAttackDefenseKernelSchemaVersion = 1;
inline constexpr std::uint32_t
    kRandomTargetWeaponResourceAttackDefenseObservationSchemaVersion = 6;
inline constexpr const char *kRandomTargetWeaponResourceAttackDefenseRulesetId =
    "plain-elemental-combo-stochastic-chance-absorption-weapon-dynamic-mp-"
...
inline constexpr const char *kIllnessWeaponResourceAttackDefenseRulesetId =
    ...
    "redraw-duel-v1";
inline constexpr std::uint32_t
    kIllnessCureResourceAttackDefenseKernelSchemaVersion = 1;
inline constexpr std::uint32_t
    kIllnessCureResourceAttackDefenseObservationSchemaVersion = 7;
inline constexpr const char *kIllnessCureResourceAttackDefenseRulesetId =
    "plain-elemental-combo-stochastic-chance-absorption-weapon-dynamic-mp-"
    "same-damage-weapon-attack-twice-weapon-random-target-weapon-illness-"
    "weapon-illness-cure-additive-reflection-dual-role-resource-miracle-"
    "attack-defense-redraw-duel-v1";
inline constexpr std::uint32_t
    kHeavenHerbResourceAttackDefenseKernelSchemaVersion = 1;
inline constexpr std::uint32_t
    kHeavenHerbResourceAttackDefenseObservationSchemaVersion = 7;
inline constexpr const char *kHeavenHerbResourceAttackDefenseRulesetId =
    "plain-elemental-combo-stochastic-chance-absorption-weapon-dynamic-mp-"
    "same-damage-weapon-attack-twice-weapon-random-target-weapon-illness-"
...
inline constexpr const char *kMiracleBounceResourceAttackDefenseRulesetId =
    ...
    "attack-defense-redraw-duel-v1";
inline constexpr std::uint32_t
    kMiracleBounceWeaponResourceAttackDefenseKernelSchemaVersion = 1;
inline constexpr std::uint32_t
    kMiracleBounceWeaponResourceAttackDefenseObservationSchemaVersion = 7;
inline constexpr const char
    *kMiracleBounceWeaponResourceAttackDefenseRulesetId =
        "plain-elemental-combo-stochastic-chance-absorption-weapon-dynamic-mp-"
        "same-damage-weapon-attack-twice-weapon-random-target-weapon-illness-"
        "weapon-illness-cure-heaven-herb-fever-mask-miracle-block-armor-"
        "weapon-miracle-bounce-armor-weapon-additive-reflection-dual-role-"
        "resource-miracle-attack-defense-redraw-duel-v1";
inline constexpr std::uint32_t
    kMiracleBounceMiracleResourceAttackDefenseKernelSchemaVersion = 1;
inline constexpr std::uint32_t
    kMiracleBounceMiracleResourceAttackDefenseObservationSchemaVersion = 7;
inline constexpr const char
    *kMiracleBounceMiracleResourceAttackDefenseRulesetId =
        "plain-elemental-combo-stochastic-chance-absorption-weapon-dynamic-mp-"
        "same-damage-weapon-attack-twice-weapon-random-target-weapon-illness-"
        "weapon-illness-cure-heaven-herb-fever-mask-miracle-block-armor-"
...
public:
  ...
  [[nodiscard]] bool attack_twice_weapon_curriculum() const noexcept {
    return attack_twice_weapon_curriculum_;
  }
  ...
  [[nodiscard]] bool illness_cure_curriculum() const noexcept {
    return illness_cure_curriculum_;
  }
  ...
  [[nodiscard]] bool miracle_bounce_weapon_curriculum() const noexcept {
    return miracle_bounce_weapon_curriculum_;
  }
...
protected:
  AttackDefenseBatch(
      ...
      bool attack_twice_weapon_curriculum = false,
      ...
      bool illness_cure_curriculum = false,
      TokenInput illness_cure_token_ids = {},
      ...
      bool miracle_bounce_weapon_curriculum = false,
...
private:
  ...
  void draw_same_damage_weapon(std::size_t environment, std::size_t player,
                               std::size_t slot);
  void draw_attack_twice_weapon(std::size_t environment, std::size_t player,
                                std::size_t slot);
  ...
  void draw_illness_weapon(std::size_t environment, std::size_t player,
                           std::size_t slot);
  void draw_illness_cure(std::size_t environment, std::size_t player,
                         std::size_t slot);
  ...
  void draw_miracle_bounce_armor(std::size_t environment, std::size_t player,
                                 std::size_t slot);
  void draw_miracle_bounce_booster(std::size_t environment, std::size_t player,
                                   std::size_t slot);
  ...
  std::vector<std::uint32_t> attack_twice_weapon_token_ids_;
  std::vector<std::uint16_t> attack_twice_weapon_attack_values_;
  std::vector<std::uint8_t> attack_twice_weapon_elements_;
  ...
  std::vector<std::uint32_t> illness_cure_token_ids_;
  std::vector<std::uint16_t> illness_cure_costs_;
  ...
  std::vector<std::uint32_t> miracle_bounce_booster_token_ids_;
...
class DynamicMpWeaponResourceAttackDefenseBatch final
    : public AttackDefenseBatch {
public:
...
class AttackTwiceWeaponResourceAttackDefenseBatch final
    : public AttackDefenseBatch {
public:
...
class RandomTargetWeaponResourceAttackDefenseBatch final
    : public AttackDefenseBatch {
public:
...
class IllnessCureResourceAttackDefenseBatch final : public AttackDefenseBatch {
public:
...
class HeavenHerbResourceAttackDefenseBatch final : public AttackDefenseBatch {
public:
