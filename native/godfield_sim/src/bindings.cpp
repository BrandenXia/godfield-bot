...
using godfield_sim::AttackTwiceWeaponResourceAttackDefenseBatch;
...
using godfield_sim::IllnessWeaponResourceAttackDefenseBatch;
using godfield_sim::RandomTargetWeaponResourceAttackDefenseBatch;
...
NB_MODULE(_native, module) {
  ...
  module.attr(
      ...
      godfield_sim::kDynamicMpWeaponResourceAttackDefenseKernelSchemaVersion;
  module.attr(
  ...
  module.attr(
      ...
      godfield_sim::kAttackTwiceWeaponResourceAttackDefenseKernelSchemaVersion;
  module.attr("ATTACK_TWICE_WEAPON_RESOURCE_ATTACK_DEFENSE_OBSERVATION_SCHEMA_"
              "VERSION") = godfield_sim::
      kAttackTwiceWeaponResourceAttackDefenseObservationSchemaVersion;
  module.attr("ATTACK_TWICE_WEAPON_RESOURCE_ATTACK_DEFENSE_RULESET_ID") =
      godfield_sim::kAttackTwiceWeaponResourceAttackDefenseRulesetId;
  module.attr(
      "RANDOM_TARGET_WEAPON_RESOURCE_ATTACK_DEFENSE_KERNEL_SCHEMA_VERSION") =
      godfield_sim::kRandomTargetWeaponResourceAttackDefenseKernelSchemaVersion;
  module.attr("RANDOM_TARGET_WEAPON_RESOURCE_ATTACK_DEFENSE_OBSERVATION_SCHEMA_"
              "VERSION") = godfield_sim::
      kRandomTargetWeaponResourceAttackDefenseObservationSchemaVersion;
  module.attr("RANDOM_TARGET_WEAPON_RESOURCE_ATTACK_DEFENSE_RULESET_ID") =
      godfield_sim::kRandomTargetWeaponResourceAttackDefenseRulesetId;
  module.attr("ILLNESS_WEAPON_RESOURCE_ATTACK_DEFENSE_KERNEL_SCHEMA_VERSION") =
      godfield_sim::kIllnessWeaponResourceAttackDefenseKernelSchemaVersion;
  module.attr(
      "ILLNESS_WEAPON_RESOURCE_ATTACK_DEFENSE_OBSERVATION_SCHEMA_VERSION") =
      godfield_sim::kIllnessWeaponResourceAttackDefenseObservationSchemaVersion;
  module.attr("ILLNESS_WEAPON_RESOURCE_ATTACK_DEFENSE_RULESET_ID") =
      godfield_sim::kIllnessWeaponResourceAttackDefenseRulesetId;
  module.attr("ILLNESS_CURE_RESOURCE_ATTACK_DEFENSE_KERNEL_SCHEMA_VERSION") =
      godfield_sim::kIllnessCureResourceAttackDefenseKernelSchemaVersion;
  module.attr(
      "ILLNESS_CURE_RESOURCE_ATTACK_DEFENSE_OBSERVATION_SCHEMA_VERSION") =
      godfield_sim::kIllnessCureResourceAttackDefenseObservationSchemaVersion;
  module.attr("ILLNESS_CURE_RESOURCE_ATTACK_DEFENSE_RULESET_ID") =
      godfield_sim::kIllnessCureResourceAttackDefenseRulesetId;
  module.attr("HEAVEN_HERB_RESOURCE_ATTACK_DEFENSE_KERNEL_SCHEMA_VERSION") =
      godfield_sim::kHeavenHerbResourceAttackDefenseKernelSchemaVersion;
  module.attr(
  ...
  module.attr("MIRACLE_BLOCK_RESOURCE_ATTACK_DEFENSE_KERNEL_SCHEMA_VERSION") =
      godfield_sim::kMiracleBlockResourceAttackDefenseKernelSchemaVersion;
  module.attr(
  ...
  module.attr("MIRACLE_BOUNCE_RESOURCE_ATTACK_DEFENSE_KERNEL_SCHEMA_VERSION") =
      godfield_sim::kMiracleBounceResourceAttackDefenseKernelSchemaVersion;
  module.attr(
  ...
  module.attr(
      ...
      godfield_sim::kMiracleReflectionResourceAttackDefenseKernelSchemaVersion;
  module.attr(
  ...
  module.attr("DARK_CLOUD_RESOURCE_ATTACK_DEFENSE_KERNEL_SCHEMA_VERSION") =
      godfield_sim::kDarkCloudResourceAttackDefenseKernelSchemaVersion;
  module.attr("DARK_CLOUD_RESOURCE_ATTACK_DEFENSE_OBSERVATION_SCHEMA_VERSION") =
  ...
  module.attr("CARD_KIND_ATTACK_TWICE_WEAPON") = std::uint8_t{20U};
  module.attr("CARD_KIND_RANDOM_TARGET_WEAPON") = std::uint8_t{21U};
  module.attr("CARD_KIND_ILLNESS_WEAPON") = std::uint8_t{22U};
  ...
  nb::class_<AttackDefenseBatch>(module, "AttackDefenseBatch")
      ...
      .def_prop_ro("attack_twice_weapon_curriculum",
                   &AttackDefenseBatch::attack_twice_weapon_curriculum)
      .def_prop_ro("random_target_weapon_curriculum",
                   &AttackDefenseBatch::random_target_weapon_curriculum)
      .def_prop_ro("illness_weapon_curriculum",
                   &AttackDefenseBatch::illness_weapon_curriculum)
      .def_prop_ro("illness_cure_curriculum",
      ...
      .def_prop_ro("pending_elements",
                   ...
                   nb::rv_policy::reference_internal)
      .def_prop_ro("pending_base_kinds",
                   &AttackDefenseBatch::pending_base_kinds_view,
                   nb::rv_policy::reference_internal)
      .def_prop_ro("pending_strikes_remaining",
                   &AttackDefenseBatch::pending_strikes_remaining_view,
                   nb::rv_policy::reference_internal)
      .def_prop_ro("pending_reflected",
                   &AttackDefenseBatch::pending_reflected_view,
                   nb::rv_policy::reference_internal)
      .def_prop_ro("pending_bounced", &AttackDefenseBatch::pending_bounced_view,
                   nb::rv_policy::reference_internal)
  ...
  nb::class_<DynamicMpWeaponResourceAttackDefenseBatch, AttackDefenseBatch>(
      module, "DynamicMpWeaponResourceAttackDefenseBatch")
      .def(
          nb::init<std::size_t, godfield_sim::TokenInput,
                   godfield_sim::ValueInput, godfield_sim::ElementInput,
                   godfield_sim::TokenInput, godfield_sim::ValueInput,
  ...
  nb::class_<AttackTwiceWeaponResourceAttackDefenseBatch, AttackDefenseBatch>(
      module, "AttackTwiceWeaponResourceAttackDefenseBatch")
      .def(
          nb::init<std::size_t, godfield_sim::TokenInput,
                   godfield_sim::ValueInput, godfield_sim::ElementInput,
                   godfield_sim::TokenInput, godfield_sim::ValueInput,
          ...
          nb::arg("attack_twice_weapon_elements"), nb::arg("seed") = 67U,
          nb::arg("initial_hp") = 40U, nb::arg("initial_mp") = 10U);

  nb::class_<RandomTargetWeaponResourceAttackDefenseBatch, AttackDefenseBatch>(
      module, "RandomTargetWeaponResourceAttackDefenseBatch")
      .def(
          nb::init<std::size_t, godfield_sim::TokenInput,
                   godfield_sim::ValueInput, godfield_sim::ElementInput,
                   godfield_sim::TokenInput, godfield_sim::ValueInput,
          ...
          nb::arg("random_target_weapon_elements"), nb::arg("seed") = 67U,
          nb::arg("initial_hp") = 40U, nb::arg("initial_mp") = 10U);

  nb::class_<IllnessWeaponResourceAttackDefenseBatch, AttackDefenseBatch>(
      module, "IllnessWeaponResourceAttackDefenseBatch")
      .def(
          nb::init<std::size_t, godfield_sim::TokenInput,
                   godfield_sim::ValueInput, godfield_sim::ElementInput,
                   godfield_sim::TokenInput, godfield_sim::ValueInput,
  ...
  nb::class_<IllnessCureResourceAttackDefenseBatch, AttackDefenseBatch>(
      module, "IllnessCureResourceAttackDefenseBatch")
      .def(
          nb::init<std::size_t, godfield_sim::TokenInput,
                   godfield_sim::ValueInput, godfield_sim::ElementInput,
                   godfield_sim::TokenInput, godfield_sim::ValueInput,
          ...
          nb::arg("illness_cure_scopes"), nb::arg("seed") = 67U,
          nb::arg("initial_hp") = 40U, nb::arg("initial_mp") = 10U);

  nb::class_<HeavenHerbResourceAttackDefenseBatch, AttackDefenseBatch>(
      module, "HeavenHerbResourceAttackDefenseBatch")
      .def(
          nb::init<std::size_t, godfield_sim::TokenInput,
                   godfield_sim::ValueInput, godfield_sim::ElementInput,
                   godfield_sim::TokenInput, godfield_sim::ValueInput,
  ...
  nb::class_<FeverMaskResourceAttackDefenseBatch, AttackDefenseBatch>(
      ...
      .def(
          ...
          nb::arg("miracle_bounce_miracle_costs"),
          nb::arg("miracle_reflection_armor_token_ids"),
          ...
          nb::arg("fog_miracle_costs"), nb::arg("dark_cloud_weapon_token_ids"),
          nb::arg("dark_cloud_weapon_attack_values"),
