...
def test_training_config_selects_versioned_mixed_hand_ruleset() -> None:
    ...
    assert (
        SimulationTrainingConfig(ruleset="dual-role-resource-hand").ruleset
    ...
    assert (
        SimulationTrainingConfig(ruleset="attack-twice-weapon-resource-hand").ruleset
    ...
    assert (
        SimulationTrainingConfig(ruleset="illness-cure-resource-hand").ruleset
        == "illness-cure-resource-hand"
    )
    assert (
        SimulationTrainingConfig(ruleset="heaven-herb-resource-hand").ruleset
